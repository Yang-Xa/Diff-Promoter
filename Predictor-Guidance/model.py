...
# self.down1_conv1 = ResidualBlock(16, 16, 2 * 128)
#         self.down1_conv2 = ResidualBlock(16, 16, 2 * 128)
#         self.down1_attn = Residual(PreNorm(16, LinearAttention(16)))
#         self.down1_conv3 = Downsample(16, 32)

#         self.down2_conv1 = ResidualBlock(32, 32, 2 * 128)
#         self.down2_conv2 = ResidualBlock(32, 32, 2 * 128)
#         self.down2_attn = Residual(PreNorm(32, LinearAttention(32)))
#         self.down2_conv3 = Downsample(32, 64)

#         self.down3_conv1 = ResidualBlock(64, 64, 2 * 128)
#         self.down3_conv2 = ResidualBlock(64, 64, 2 * 128)
#         self.down3_attn = Residual(PreNorm(64, LinearAttention(64)))
#         self.down3_conv3 = Downsample(64, 128)

#         self.mid_conv1 = ResidualBlock(128, 128, 2 * 128)
#         self.mid_attn = Residual(PreNorm(128, Attention(128)))
#         self.mid_conv2 = ResidualBlock(128, 128, 2 * 128)

#         self.up3_conv1 = ResidualBlock(128 + 64, 128, 2 * 128)
#         self.up3_conv2 = ResidualBlock(128 + 64, 128, 2 * 128)
#         self.up3_attn = Residual(128, LinearAttention(128))
#         self.up3_conv3 = Upsample(128, 64)

#         self.up2_conv1 = ResidualBlock(64 + 32, 64, 2 * 128)
#         self.up2_conv2 = ResidualBlock(64 + 32, 64, 2 * 128)
#         self.up2_attn = Residual(64, LinearAttention(64))
#         self.up2_conv3 = Upsample(64, 32)

#         self.up3_conv1 = ResidualBlock(32 + 16, 32, 2 * 128)
#         self.up3_conv2 = ResidualBlock(32 + 16, 32, 2 * 128)
#         self.up3_attn = Residual(32, LinearAttention(32))
#         self.up3_conv3 = Upsample(32, 16)
